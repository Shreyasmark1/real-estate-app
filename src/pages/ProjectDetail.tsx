    ...
    return (
        <div>
            <img
                ...
                srcSet={searchBackground}
            />
            <div className="p-5 text-3xl">3 bedroom, Modern apartment</div>
            <Tabs defaultValue="account" className="w-full">
                <TabsList className="grid w-full grid-cols-3">
                    <TabsTrigger value="account">Description</TabsTrigger>
                    <TabsTrigger value="password">Offer</TabsTrigger>
                    <TabsTrigger value="none">Interior</TabsTrigger>
                </TabsList>

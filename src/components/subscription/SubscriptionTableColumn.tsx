...
export const SubscriptionTableColumnRef = (setOpenSheet: { (value: SetStateAction<boolean>): void; (arg0: () => JSX.Element): void }): ColumnDef<SubscriptionPlan>[] => [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            const updatedAt: string  = new String(row.getValue("updatedAt")).toString()
            return (
                <div>
            ...
            return (
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="text-center">
                        ...
                        <DropdownMenuItem onClick={() => setOpenSheet(() => <PlanForm defaultValues={plan} />)}><span className="w-full"> Edit </span></DropdownMenuItem>
